...
const CreateParty = () => {
  ...
  const handleServices = (e) => {
    ...
    const fielteredService = services.filter((s) => s._id === value);

    if (checked) {
      setPartyServices((services) => [...services, fielteredService[0]]);
    } else {
  ...
  return (
    <div className="form-page">
      ...
      <p>Defina oseu orçamento e escolha os serviços</p>
